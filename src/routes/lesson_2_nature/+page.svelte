<script>
    ...
    onMount(() => {
        ...
        for (let i = 0; i < runs; i++) {
          setTimeout(() => {
            walker.step_n()
            animatedDrawCircle(walker.x, walker.y, rainbow.colorAt(i), 20);
          }, i*20);
        }
        }
...
<div class="p-4 sm:ml-64">
    ...
    <h2> Random Walker - Normal Distribution </h2>
    <p>
        A random walker containing a normal distriribution, creating a paint splotch effect.

        From this point on, i've realised that canvas is no longer the best route for this kind of drawing, and started moving onto shader code.
    </p>
    </article>
